function [Th,fractionalBandwidth,centerFrequency]=acunav128_fullap(FIELD_PARAMS);
% function [Th,fractionalBandwidth,centerFrequency]=acunav128_fullap(FIELD_PARAMS);
%
...
% Mark 08/25/09
%
% always use the full aperture of the acunav128

disp('Transducer: AcuNav (128 element, full aperture)');
no_elements_y=1;
width=0.09e-3;
kerf=0.02e-3;
pitch = width + kerf;
